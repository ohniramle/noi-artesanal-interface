...
const NAV_ITEMS: NavItemDef[] = [
  { href: '/', icon: <LayoutDashboard className="h-4 w-4" />, label: 'Visão geral', active: true },
  { href: '/app/pedidos', icon: <ClipboardList className="h-4 w-4" />, label: 'Pedidos' },
  { href: '/app/clientes', icon: <Users className="h-4 w-4" />, label: 'Clientes' },
  { href: '/app/pizzas', icon: <Pizza className="h-4 w-4" />, label: 'Pizzas' },
  { href: '/app/relatorios', icon: <TrendingUp className="h-4 w-4" />, label: 'Relatórios' },
]
